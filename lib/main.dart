...
import 'package:doctorappointment/screens/payment_page.dart';
import 'package:doctorappointment/screens/success_book.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        'success_book': (context) => const SuccessBook(),
      },
    );
  }
}
